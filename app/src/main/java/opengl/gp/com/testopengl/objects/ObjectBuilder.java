...
public class ObjectBuilder {
    ...
    private static int sizeOfCircleInVetices(int numPoints){
    ...
    static GeneratedData createPuck(Geometry.Cylinder puck, final int numPoints){
        int size  = sizeOfCircleInVetices(numPoints)+sizeOfOpenCylinderInVertices(numPoints);
    ...
    static GeneratedData createMallet(Geometry.Point center,float radius,float height,int numPoints){
        int size = sizeOfCircleInVetices(numPoints)*2 + sizeOfOpenCylinderInVertices(numPoints)*2;
    ...
    private void appendOpenCyLinder(Geometry.Cylinder cylinder,int numPoints){
        final int startVertex = offset/FLOATS_PER_VERTEX;
        final int numVertices = sizeOfCircleInVetices(numPoints);
